...
module BmpCalculations
  ...
  def computeBmpCalculations(field)
    ...
    if (field.field_type_id == 1 || field.field_type_id == 2 || field.field_type_id == 3)
      ...
      if (field.is_forest_buffer?)
        ...
        if (field.forest_buffer_average_width >= 35 && field.forest_buffer_average_width <= 100)
          ...
          forest_buffer_functional_acres = field.forest_buffer_length * 100.0 / 43560.0
        end
      end
      ...
      if (field.is_forest_buffer_future?)
        ...
        if (field.forest_buffer_average_width_future >= 35 && field.forest_buffer_average_width_future <= 100)
          ...
          forest_buffer_functional_acres_future = field.forest_buffer_length_future * 100.0 / 43560.0
        end
      end
    ...
    if (field.is_pasture_adjacent_to_stream && field.is_streambank_restoration)
    ...
    if (field.is_pasture_adjacent_to_stream && field.is_streambank_restoration_future)
      total_n_for_unconverted_acre_future = [0, total_n_for_unconverted_acre_future - (field.streambank_restoration_length_future * 0.2)].max # cannot be negative
      total_p_for_unconverted_acre_future = [0, total_p_for_unconverted_acre_future - (field.streambank_restoration_length_future * 0.068)].max # cannot be negative
      total_sediment_for_unconverted_acre_future = [0, total_sediment_for_unconverted_acre_future - (field.streambank_restoration_length_future * 0.027125)].max # cannot be negative
    end
    ...
    field.totals = {:ntt_results => @ntt_results, :ntt_results_future => @ntt_results_future, :total_n_per_acre => total_n_per_acre, :total_p_per_acre => total_p_per_acre, :total_sediment_per_acre => total_sediment_per_acre, :total_n_per_acre_future => total_n_per_acre_future, :total_p_per_acre_future => total_p_per_acre_future, :total_sediment_per_acre_future => total_sediment_per_acre_future, :total_adjusted_n_per_acre => total_adjusted_n_per_acre, :total_adjusted_p_per_acre => total_adjusted_p_per_acre, :total_adjusted_sediment_per_acre => total_adjusted_sediment_per_acre, :total_adjusted_n_per_acre_future => total_adjusted_n_per_acre_future, :total_adjusted_p_per_acre_future => total_adjusted_p_per_acre_future, :total_adjusted_sediment_per_acre_future => total_adjusted_sediment_per_acre_future, :fencing_acres => fencing_acres, :fencing_acres_future => fencing_acres_future, :fencing_functional_acres => fencing_functional_acres, :fencing_functional_acres_future => fencing_functional_acres_future, :stream_forest_n_conversion => stream_forest_n_conversion, :stream_forest_p_conversion => stream_forest_p_conversion, :stream_forest_sediment_conversion => stream_forest_sediment_conversion, :stream_forest_n_conversion_future => stream_forest_n_conversion_future, :stream_forest_p_conversion_future => stream_forest_p_conversion_future, :stream_forest_sediment_conversion_future => stream_forest_sediment_conversion_future, :stream_hyo_n_conversion => stream_hyo_n_conversion, :stream_hyo_p_conversion => stream_hyo_p_conversion, :stream_hyo_sediment_conversion => stream_hyo_sediment_conversion, :stream_hyo_n_conversion_future => stream_hyo_n_conversion_future, :stream_hyo_p_conversion_future => stream_hyo_p_conversion_future, :stream_hyo_sediment_conversion_future => stream_hyo_sediment_conversion_future, :degraded_pasture_acres => degraded_pasture_acres, :degraded_pasture_acres_future => degraded_pasture_acres_future, :trp_n_conversion => trp_n_conversion, :trp_p_conversion => trp_p_conversion, :trp_sediment_conversion => trp_sediment_conversion, :trp_n_conversion_future => trp_n_conversion_future, :trp_p_conversion_future => trp_p_conversion_future, :trp_sediment_conversion_future => trp_sediment_conversion_future, :grass_buffer_acres => grass_buffer_acres, :grass_buffer_functional_acres => grass_buffer_functional_acres, :grass_buffer_functional_acres_future => grass_buffer_functional_acres_future, :buffer_hyo_n_conversion => buffer_hyo_n_conversion, :buffer_hyo_p_conversion => buffer_hyo_p_conversion, :buffer_hyo_sediment_conversion => buffer_hyo_sediment_conversion, :buffer_hyo_n_conversion_future => buffer_hyo_n_conversion_future, :buffer_hyo_p_conversion_future => buffer_hyo_p_conversion_future, :buffer_hyo_sediment_conversion_future => buffer_hyo_sediment_conversion_future, :forest_buffer_acres => forest_buffer_acres, :forest_buffer_functional_acres => forest_buffer_functional_acres, :forest_buffer_acres_future => forest_buffer_acres_future, :forest_buffer_functional_acres_future => forest_buffer_functional_acres_future, :buffer_forest_n_conversion => buffer_forest_n_conversion, :buffer_forest_p_conversion => buffer_forest_p_conversion, :buffer_forest_sediment_conversion => buffer_forest_sediment_conversion, :buffer_forest_n_conversion_future => buffer_forest_n_conversion_future, :buffer_forest_p_conversion_future => buffer_forest_p_conversion_future, :buffer_forest_sediment_conversion_future => buffer_forest_sediment_conversion_future, :fertilizer_buffer_acres => fertilizer_buffer_acres, :fertilizer_buffer_functional_acres => fertilizer_buffer_functional_acres, :fertilizer_buffer_acres_future => fertilizer_buffer_acres_future, :fertilizer_buffer_functional_acres_future => fertilizer_buffer_functional_acres_future, :buffer_fertilizer_n_conversion => buffer_fertilizer_n_conversion, :buffer_fertilizer_p_conversion => buffer_fertilizer_p_conversion, :buffer_fertilizer_sediment_conversion => buffer_fertilizer_sediment_conversion, :buffer_fertilizer_n_conversion_future => buffer_fertilizer_n_conversion_future, :buffer_fertilizer_p_conversion_future => buffer_fertilizer_p_conversion_future, :buffer_fertilizer_sediment_conversion_future => buffer_fertilizer_sediment_conversion_future, :wetland_acres => wetland_acres, :wetland_forest_n_conversion => wetland_forest_n_conversion, :wetland_forest_p_conversion => wetland_forest_p_conversion, :wetland_forest_sediment_conversion => wetland_forest_sediment_conversion, :wetland_acres_future => wetland_acres_future, :wetland_forest_n_conversion_future => wetland_forest_n_conversion_future, :wetland_forest_p_conversion_future => wetland_forest_p_conversion_future, :wetland_forest_sediment_conversion_future => wetland_forest_sediment_conversion_future, :other_land_use_conversion_acres => other_land_use_conversion_acres, :other_land_use_conversion_acres_future => other_land_use_conversion_acres_future, :other_land_use_conversion_forest_n_conversion => other_land_use_conversion_forest_n_conversion, :other_land_use_conversion_forest_p_conversion => other_land_use_conversion_forest_p_conversion, :other_land_use_conversion_forest_sediment_conversion => other_land_use_conversion_forest_sediment_conversion, :other_land_use_conversion_forest_n_conversion_future => other_land_use_conversion_forest_n_conversion_future, :other_land_use_conversion_forest_p_conversion_future => other_land_use_conversion_forest_p_conversion_future, :other_land_use_conversion_forest_sediment_conversion_future => other_land_use_conversion_forest_sediment_conversion_future, :other_land_use_conversion_hyo_n_conversion => other_land_use_conversion_hyo_n_conversion, :other_land_use_conversion_hyo_p_conversion => other_land_use_conversion_hyo_p_conversion, :other_land_use_conversion_hyo_sediment_conversion => other_land_use_conversion_hyo_sediment_conversion, :other_land_use_conversion_hyo_n_conversion_future => other_land_use_conversion_hyo_n_conversion_future, :other_land_use_conversion_hyo_p_conversion_future => other_land_use_conversion_hyo_p_conversion_future, :other_land_use_conversion_hyo_sediment_conversion_future => other_land_use_conversion_hyo_sediment_conversion_future, :total_converted_acres => total_converted_acres, :total_unconverted_acres => total_unconverted_acres, :total_converted_acres_future => total_converted_acres_future, :total_unconverted_acres_future => total_unconverted_acres_future, :total_p_for_converted_acre => total_p_for_converted_acre, :total_sediment_for_converted_acre => total_sediment_for_converted_acre, :total_n_for_converted_acre_future => total_n_for_converted_acre_future, :total_p_for_converted_acre_future  => total_p_for_converted_acre_future, :total_sediment_for_converted_acre_future => total_sediment_for_converted_acre_future, :bmp_efficiency_for_forest => bmp_efficiency_for_forest, :n_reduction_for_forest => n_reduction_for_forest, :p_reduction_for_forest => p_reduction_for_forest, :sediment_reduction_for_forest => sediment_reduction_for_forest, :bmp_efficiency_for_grass => bmp_efficiency_for_grass, :n_reduction_for_grass => n_reduction_for_grass, :p_reduction_for_grass => p_reduction_for_grass, :sediment_reduction_for_grass => sediment_reduction_for_grass, :grass_fence_treated_upland_acres_n => grass_fence_treated_upland_acres_n, :grass_fence_treated_upland_acres_p => grass_fence_treated_upland_acres_p, :grass_fence_treated_upland_acres_sediment => grass_fence_treated_upland_acres_sediment, :upland_streambank_grass_n_reduction => upland_streambank_grass_n_reduction, :upland_streambank_grass_p_reduction => upland_streambank_grass_p_reduction, :upland_streambank_grass_sediment_reduction => upland_streambank_grass_sediment_reduction, :grass_fence_treated_upland_acres_n_future => grass_fence_treated_upland_acres_n_future, :grass_fence_treated_upland_acres_p_future => grass_fence_treated_upland_acres_p_future, :grass_fence_treated_upland_acres_sediment_future => grass_fence_treated_upland_acres_sediment_future, :upland_streambank_grass_n_reduction_future => upland_streambank_grass_n_reduction_future, :upland_streambank_grass_p_reduction_future => upland_streambank_grass_p_reduction_future, :upland_streambank_grass_sediment_reduction_future => upland_streambank_grass_sediment_reduction_future, :forest_fence_treated_upland_acres_n => forest_fence_treated_upland_acres_n, :forest_fence_treated_upland_acres_p => forest_fence_treated_upland_acres_p, :forest_fence_treated_upland_acres_sediment => forest_fence_treated_upland_acres_sediment, :upland_streambank_forest_n_reduction => upland_streambank_forest_n_reduction, :upland_streambank_forest_p_reduction => upland_streambank_forest_p_reduction, :upland_streambank_forest_sediment_reduction => upland_streambank_forest_sediment_reduction, :forest_fence_treated_upland_acres_n_future => forest_fence_treated_upland_acres_n_future, :forest_fence_treated_upland_acres_p_future => forest_fence_treated_upland_acres_p_future, :forest_fence_treated_upland_acres_sediment_future => forest_fence_treated_upland_acres_sediment_future, :upland_streambank_forest_n_reduction_future => upland_streambank_forest_n_reduction_future, :upland_streambank_forest_p_reduction_future => upland_streambank_forest_p_reduction_future, :upland_streambank_forest_sediment_reduction_future => upland_streambank_forest_sediment_reduction_future, :grass_buffer_treated_upland_acres_n => grass_buffer_treated_upland_acres_n, :grass_buffer_treated_upland_acres_p => grass_buffer_treated_upland_acres_p, :grass_buffer_treated_upland_acres_sediment => grass_buffer_treated_upland_acres_sediment, :grass_buffer_treated_upland_acres_n_future => grass_buffer_treated_upland_acres_n_future, :grass_buffer_treated_upland_acres_p_future => grass_buffer_treated_upland_acres_p_future, :grass_buffer_treated_upland_acres_sediment_future => grass_buffer_treated_upland_acres_sediment_future, :upland_grass_buffer_n_reduction_future => upland_grass_buffer_n_reduction_future, :upland_grass_buffer_p_reduction_future => upland_grass_buffer_p_reduction_future, :upland_grass_buffer_sediment_reduction_future => upland_grass_buffer_sediment_reduction_future, :forest_buffer_treated_upland_acres_n => forest_buffer_treated_upland_acres_n, :forest_buffer_treated_upland_acres_p => forest_buffer_treated_upland_acres_p, :forest_buffer_treated_upland_acres_sediment => forest_buffer_treated_upland_acres_sediment, :upland_forest_buffer_n_reduction => upland_forest_buffer_n_reduction, :upland_forest_buffer_p_reduction => upland_forest_buffer_p_reduction, :upland_forest_buffer_sediment_reduction => upland_forest_buffer_sediment_reduction, :forest_buffer_treated_upland_acres_n_future => forest_buffer_treated_upland_acres_n_future, :forest_buffer_treated_upland_acres_p_future => forest_buffer_treated_upland_acres_p_future, :forest_buffer_treated_upland_acres_sediment_future => forest_buffer_treated_upland_acres_sediment_future, :upland_forest_buffer_n_reduction_future => upland_forest_buffer_n_reduction_future, :upland_forest_buffer_p_reduction_future => upland_forest_buffer_p_reduction_future, :upland_forest_buffer_sediment_reduction_future => upland_forest_buffer_sediment_reduction_future, :bmp_efficiency_for_wetland => bmp_efficiency_for_wetland, :n_reduction_for_wetland => n_reduction_for_wetland, :p_reduction_for_wetland => p_reduction_for_wetland, :sediment_reduction_for_wetland => sediment_reduction_for_wetland, :upland_wetland_treated_area_n => upland_wetland_treated_area_n, :upland_wetland_treated_area_p => upland_wetland_treated_area_p, :upland_wetland_treated_area_sediment => upland_wetland_treated_area_sediment, :upland_wetland_n_reduction => upland_wetland_n_reduction, :upland_wetland_p_reduction => upland_wetland_p_reduction, :upland_wetland_sediment_reduction => upland_wetland_sediment_reduction, :upland_wetland_treated_area_n_future => upland_wetland_treated_area_n_future, :upland_wetland_treated_area_p_future => upland_wetland_treated_area_p_future, :upland_wetland_treated_area_sediment_future => upland_wetland_treated_area_sediment_future, :upland_wetland_n_reduction_future => upland_wetland_n_reduction_future, :upland_wetland_p_reduction_future => upland_wetland_p_reduction_future, :upland_wetland_sediment_reduction_future => upland_wetland_sediment_reduction_future, :new_total_n_per_acre => new_total_n_per_acre, :new_total_p_per_acre => new_total_p_per_acre, :new_total_sediment_per_acre => new_total_sediment_per_acre, :new_total_n_per_acre_future => new_total_n_per_acre_future, :new_total_p_per_acre_future => new_total_p_per_acre_future, :new_total_sediment_per_acre_future => new_total_sediment_per_acre_future, :total_n_for_unconverted_acre => total_n_for_unconverted_acre, :total_p_for_unconverted_acre => total_p_for_unconverted_acre, :total_sediment_for_unconverted_acre => total_sediment_for_unconverted_acre, :total_n_for_unconverted_acre_future => total_n_for_unconverted_acre_future, :total_p_for_unconverted_acre_future => total_p_for_unconverted_acre_future, :total_sediment_for_unconverted_acre_future => total_sediment_for_unconverted_acre_future, :new_total_n => new_total_n, :total_n_for_converted_acre => total_n_for_converted_acre, :total_n_for_unconverted_acre => total_n_for_unconverted_acre, :new_total_p => new_total_p, :new_total_sediment => new_total_sediment, :new_total_n_future => new_total_n_future, :new_total_p_future => new_total_p_future, :new_total_sediment_future => new_total_sediment_future, :error_message => ''}
    # field.save!
...
def computeBmpCalculationsWithoutConversion(field)
    ...
    # other land conversion
    other_land_use_conversion_acres = 0
    other_land_use_conversion_acres_future = 0
