...
(function (e, t) {
    ...
    b.fn.extend({css: function (e, n) {
        ...
        b.support.reliableMarginRight || (b.cssHooks.marginRight = {get: function (e, t) {
            if (t)return b.swap(e, {display: "inline-block"}, Rt, [e, "marginRight"])
    ...
    (r.inputChangeSelector, "change.rails", function (t) {
        var n = e(this);
    ...
    $(document).ready(function () {
        if ($(".checkHTML5")[0].type !== "date")return $("form [required]").addClass("required").removeAttr("required")
    })
}.call(this), function () {
}.call(this), function () {
}.call(this), function () {
